...
userRouter.post("/user", validateSchema(createSchema), hashPassword, userController.post);

userRouter.route("/user/:id")
  .get(validateInt, userController.getOne)
  .patch(validateInt, validateSchema(updateSchema), hashPassword, userController.update)
